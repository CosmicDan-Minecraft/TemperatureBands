...
public class HumidityMarked extends MarkedNoiseEx implements OwnerFunction {
    public HumidityMarked(String dimensionName, DimensionConfig config, DensityFunction funcOriginal) {
    ...
    public @NotNull DensityFunction mapAll(Visitor visitor) {
        return visitor.apply(new HumidityMarked(dimensionName, config, funcOriginal.mapAll(visitor)));
    }
