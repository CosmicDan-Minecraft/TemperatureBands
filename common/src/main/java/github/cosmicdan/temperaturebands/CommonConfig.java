...
public class CommonConfig {
    ...
    public static final String bandSizeTxt = " The approximate size of each temperature band in blocks.\n" +
            " Vanilla Minecraft generation has 5 temperature bands - Freezing, Cool, Temperate, Warm and Hot - every biome fits into one of these five temperature ranges.\n" +
    ...
    public static final String bandPositionShiftTxt = " Shift the bands by this percentage.\n" +
            " Normally the Hot (Desert and such) will generate at origin (0,0) so the default shift of 25% will make the origin temperate (middle temp) instead, shifted\n" +
    ...
    public static final String tempRangeTxt = " Min/max temperature range. Increasing this will make the coldest and hottest bands larger while reducing others, lowering this value will have the opposite effect.\n" +
    ...
    public static final String tempGradeShiftTxt = " Vanilla temperature has a bias towards cold, this value is used to make the hottest and coldest roughly the same size.\n" +
            " If you set it to zero, the coldest band will be larger than all other bands and the hottest would be smaller than all other bands.\n" +
    ...
    public static final String noiseFactorTxt = " If above zero, will use original noise generation to help make the edges between bands a bit nicer.\n" +
            ...
            " The unit is arbitrary and very dependent on bandSize. For e.g. 100 is nice for a bandSize of 2048 but might be too wild if bandSize is lowered.";
    ...
    public static final String sectionAlgo1Txt = " Settings for algorithm 1, the 'simple' or 'default' algorithm.\n" +
            ...
            " Keeping the variance low but noiseFactor a decent amount (around 100 or so) will produce some OK looking looking curves/waves in the bands, but it you want something more predictable you can reduce noiseFactor and increase variance.\n";
